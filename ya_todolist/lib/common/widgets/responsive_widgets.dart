...
class TabletPadding extends StatelessWidget {
  const TabletPadding({super.key, required this.condition, required this.child});
...
class EditorResponsiveBuilder extends StatelessWidget {
  const EditorResponsiveBuilder({super.key, required this.condition, required this.children});
  final bool condition;
